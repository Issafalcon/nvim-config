local telescope_mappings = {
  ...
  },
  {
    "n",
    "<leader>tc",
    fignvim.search.dev_config_files,
  ...
  },
  {
    ...
    "<leader>ts",
    ":Telescope aerial<CR>",
    { desc = "Search through Aerial Symbols" },
  },
}
...
fignvim.fn.conditional_func(
  ...
  pcall(require, "fzy_native"),
  "fzy_native"
)

fignvim.fn.conditional_func(telescope.load_extension, pcall(require, "fzf"), "fzf")

fignvim.mappings.create_keymaps(telescope_mappings)
