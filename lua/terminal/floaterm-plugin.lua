...
vim.keymap.set('t', '<c-t>', "<ESC>:FloatermNew ---height=0.3 --width=0.3 --wintype=split<CR>")
vim.keymap.set('t', '<c-t>', "<c-\\><c-n>:FloatermNew --wintype=float<CR>")
vim.keymap.set('i', '<c-t>', [[<ESC>:FloatermNew --wintype=float<CR>]])
