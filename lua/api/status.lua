...
function fignvim.status.provider.spell(opts)
  opts = fignvim.fn.default_tbl(opts, { str = "", icon = { kind = "Spellcheck" }, show_empty = true })
  return function() return fignvim.ui.stylize(vim.wo.spell and opts.str, opts) end
end
