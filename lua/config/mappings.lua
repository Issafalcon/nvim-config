...
M.plugin_mappings = {
  ...
  telescope = {
    ...
    git_files = { mode = "n", lhs = "<C-p>", rhs = ":lua require('telescope.builtin').git_files()<CR>", desc = "Find files in git repo", },
    all_files = { mode = "n", lhs = "<leader>sf", rhs = ":lua require('telescope.builtin').find_files({hidden = true})<CR>", desc = "Find files in current directory" },
    buffers = { mode = "n", lhs = "<leader>sb", rhs = ":lua require('telescope.builtin').buffers()<CR>", desc = "Find buffers" },
    help_tags = { mode = "n", lhs = "<leader>sh", rhs = ":lua require('telescope.builtin').help_tags()<CR>", desc = "Find help tags" },
    dev_config = { mode = "n", lhs = "<leader>sc", rhs = fignvim.search.dev_config_files, desc = "Find config files" },
  },
}
