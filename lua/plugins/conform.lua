...
--- Return the first available formatter from the given list.
---@param bufnr integer
---@param ... string
---@return string
...
-- Run the first available prettier variant, then injected for code blocks.
opts.formatters_by_ft["markdown"] = function(bufnr)
  return { first(bufnr, "prettierd", "prettier"), "injected" }
end
opts.formatters_by_ft["markdown.mdx"] = function(bufnr)
  return { first(bufnr, "prettierd", "prettier"), "injected" }
end
