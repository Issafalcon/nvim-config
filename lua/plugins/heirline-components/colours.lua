...
local C = require("ui.colourscheme").colours

function M.setup_colors()
  local Error = fignvim.ui.get_hlgroup("Error", { fg = C.red, bg = C.bg })
  local StatusLineComponent = fignvim.ui.get_hlgroup("StatusLine", { fg = C.fg, bg = C.grey_4 })
  ...
  local DiagnosticHint = fignvim.ui.get_hlgroup("DiagnosticHint", { fg = C.blue_4, bg = C.grey_4 })
