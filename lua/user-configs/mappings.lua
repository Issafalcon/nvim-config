...
M.lsp_mappings = {
  LSP = {
    ...
    document_symbols_telescope    = { mode = "n", lhs          = "<leader>gs", rhs  = function() require('telescope.builtin').lsp_document_symbols() end, desc   = "List document symbols in Telescope" },
    workspace_symbols_telescope   = { mode = "n", lhs          = "<leader>gS", rhs  = function() require('telescope.builtin').lsp_workspace_symbols() end, desc  = "List workspace symbols in Telescope" },
    ...
    signature_overloads                = { mode = "n", lhs = "<A-s>", rhs       = ":LspOverloadsSignature<CR>", desc                          = "Show signature help with overloads" },
    signature_help                = { mode = "i", lhs = "<A-s>", rhs       = function() vim.lsp.buf.signature_help() end, desc                          = "Show signature help in insert mode" },
